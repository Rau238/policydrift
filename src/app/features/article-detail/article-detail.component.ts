...
import { NewsArticle, Author } from '../../shared/models/article.model';
import { CardSkeletonComponent } from '../../shared/skeleton/card-skeleton.component';

@Component({
  selector: 'app-article-detail',
  standalone: true,
  imports: [CommonModule, RouterLink, CardSkeletonComponent],
  template: `
...
<div class="max-w-4xl mx-auto mb-12 px-4">
  <div class="text-center py-6 border-t border-b border-gray-200">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 justify-items-center">
      <!-- Twitter -->
      <button (click)="shareOnTwitter()"
        class="w-full flex items-center justify-center gap-2 px-4 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors">
      ...
      <button (click)="shareOnFacebook()"
        class="w-full flex items-center justify-center gap-2 px-4 py-2 text-blue-800 hover:text-blue-900 hover:bg-blue-50 rounded-lg transition-colors">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path
      ...
      <button (click)="shareOnWhatsApp()"
        class="w-full flex items-center justify-center gap-2 px-4 py-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path
